        ...
        <div className="flex items-center justify-between w-full relative z-10 px-4 sm:px-8 md:px-16 my-4 sm:my-5">
          ...
          {isLoggedIn && (
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              {showAiSearch ? (
                <button
                  className="relative flex items-center space-x-2 group px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-600 rounded-md"
                ...
                >
                  ...
                  />
                  <p className="text-white text-sm sm:text-base font-semibold tracking-wide group-hover:text-red-500 transition duration-300 transform group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-red-500/50">
                    Home
                  </p>
